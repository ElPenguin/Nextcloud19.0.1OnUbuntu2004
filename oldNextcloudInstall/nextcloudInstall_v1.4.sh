...
# Important Var
COMMONNAME=$(hostname -I) # SSL and Nginx Var, example : commonname="192.168.1.1", "mywebsite.com" or "subdomain.mywebsite.com"

# MariaDB
MYSQL_ROOT_PASSWORD="" # Mysql root password
MYSQL_NEXTCLOUD_PASSWORD="ergz5uirg4664!e"

# SSL Encryption
SSL_COUNTRY="FR"
SSL_STATE="Bourgogne"
SSL_LOCALITY="Dijon"
SSL_ORGANIZATION="Uncorp"
SSL_ORGANIZATIONALUNIT="Uncorp"
SSL_EMAIL="example@email.com"
