...
echo "#######################################################################"
echo "###"
echo "###         Enter this in your browser : $COMMONNAME"
echo "###         Set your Username"
echo "###         Set your Password"
echo "###         Don't change \"Data Folder\""
echo "###         In \"Database User\" enter : nextcloud"
echo "###         In \"Database Password\" enter : $MYSQL_NEXTCLOUD_PASSWORD"
echo "###         In \"Database Name\" enter : nextclouddb"
echo "###"
echo "#######################################################################"
